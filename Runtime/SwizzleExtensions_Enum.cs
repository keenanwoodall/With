...
public static partial class SwizzleExtensions
{
    ...
    public static Vector2 Swizzle(this Vector2 v, Axis2 swizzle)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Vector3 Swizzle(this Vector3 v, Axis3 swizzle)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Vector4 Swizzle(this Vector4 v, Axis4 swizzle)
    {
